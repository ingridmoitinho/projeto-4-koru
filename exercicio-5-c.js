...
// c. Filtrar produtos da categoria "Eletrônicos" coom preço < 1000
const eletronicosAbaixoDe1000 = inventory.filter(produto => produto.category === "Eletrônicos" && produto.price < 1000);
console.log("Eletrônicos com preço abaixo de R$1000:");
eletronicosAbaixoDe1000.forEach(produto => {
