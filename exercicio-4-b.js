// Desafio: b. Use some para verificar se existe alguma tarefa de baixa prioridade completa
...
const completedLowPriority = tasks.some(
  (task) => task.priority === "baixa" && task.completed
);
console.log(
  "Existe tarefa de baixa prioridade completa?",
