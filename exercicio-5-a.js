...
// a. Mostrar uma lista formada de todos os produtos usando forEach.

inventory.forEach(produto => {
    console.log(`Produto: ${produto.name}, Preço: R$${produto.price}, Estoque: ${produto.stock}, Categoria: ${produto.category}`);
})
